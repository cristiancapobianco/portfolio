...
export default function SmokeEffect() {
    return (
        <>
            ...
            <div className="absolute top-[5%] left-[10%] z-10 pointer-events-none w-[215px] h-[180px]">
            ...
            <div className="absolute top-[35%] right-[5%] z-10 pointer-events-none w-[310px] h-[280px]">
            ...
            <div className="absolute bottom-[-0%] left-[-40%] z-10 pointer-events-none w-[1020px] h-[950px]">
            ...
            <div className="absolute bottom-[-0%] right-[-5%] z-10 pointer-events-none w-[420px] h-[380px]">
